  ...
  return (
    <div style={{ backgroundColor: '#181818', width:'100%',height: '100vh', justifyContent: 'center', alignItems: 'center' }}>
      ...
      <div className="animation-box">
        ...
        <div className="second-text">“A wish for you on your birthday, whatever you ask may you receive, whatever you seek may you find, whatever you wish may it be fulfilled on your birthday and always. Happy birthday!”</div>
        ...
        <div className="fourth-text">“Count not the candles…see the lights they give. Count not the years, but the life you live. Wishing you a wonderful time ahead. Happy birthday.”</div>
        ...
        <div className="sixth-text">HAPPY <br />BIRTHDAY</div>
